...
--
-- Host: 127.0.0.1
-- Creato il: Apr 01, 2024 alle 17:33
...
INSERT INTO `lista_corsi` (`nome`, `materia`, `grado`, `autore`, `data_inizio`, `id`) VALUES
('Arduino', 'IT Technology', 'High school diploma', 'Davide Carraro', '2023-11-20', 0),
('Learn Litherature', 'English', 'High school diploma', 'Denise De Gobbi', '2024-03-08', 1);
...
--
ALTER TABLE `corso_utente`
  MODIFY `n_progressivo` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
